package com.tcs.projecttwomoviesapp.datamodel;
...
public class Movie {
    ...
    private static final String preUrl = "https://image.tmdb.org/t/p/w780";

    public String getProductionCountries(){
        String result="";
        for(ProductionCountry p: getProduction_countries()){
    ...
    public String getProductionCompanies(){
        String result="";
        for(ProductionCompany p: getProduction_companies()){
            result = result+p.getName()+", ";
        }
        try {
            result = (result.substring(0, result.length() - 2)) + ".";
    ...
    public String getSpokenLanguages(){
        String result="";
        for(SpokenLanguage s: getSpoken_languages()){
            result = result+s.getEnglish_name()+", ";
        }
        try {
            result = (result.substring(0, result.length() - 2)) + ".";
        }
